...
typedef enum {
     ...
     */
    mh_propertyMemoryManagementPolicyAssign = 0,
    
    /**
     * The value is retained.
     */
    mh_propertyMemoryManagementPolicyRetain,
    
    /**
     * The value is copied.
     */
    mh_propertyMemoryManagementPolicyCopy
} mh_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     */
    mh_propertyMemoryManagementPolicy memoryManagementPolicy;
