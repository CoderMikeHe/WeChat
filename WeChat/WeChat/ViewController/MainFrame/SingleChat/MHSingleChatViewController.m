...
#import "MHSingleChatViewController.h"

@interface MHSingleChatViewController ()
/// viewModel
@property (nonatomic, readwrite, strong) MHSingleChatViewModel *viewModel;
@end

@implementation MHSingleChatViewController
