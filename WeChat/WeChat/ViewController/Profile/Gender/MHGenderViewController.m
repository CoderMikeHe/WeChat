...
#import "MHGenderViewController.h"

@interface MHGenderViewController ()
/// viewModel
@property (nonatomic, readonly, strong) MHGenderViewModel *viewModel;
@end

@implementation MHGenderViewController
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath withObject:(MHGenderItemViewModel *)object{
