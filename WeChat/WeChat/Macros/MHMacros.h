...
/// 导航条高度
#define MH_APPLICATION_TOP_BAR_HEIGHT 64.0f
/// tabBar高度
#define MH_APPLICATION_TAB_BAR_HEIGHT 49.0f
/// 工具条高度 (常见的高度)
#define MH_APPLICATION_TOOL_BAR_HEIGHT 44.0f
/// 状态栏高度
#define MH_APPLICATION_STATUS_BAR_HEIGHT 20.0f
